...
public record LivroDTO(Integer id, String titulo, String descricao, String opniaoDoador, Integer qtdPaginas,
		String isbn, LocalDate dataPublicacao, @JsonProperty("editora") EditoraDTO editoraDTO,
		@JsonProperty("idioma") IdiomaDTO idiomaDTO, UsuarioDTO dono, List<CategoriaDTO> categorias,
		List<AutorDTO> autores) {

	public LivroDTO(Livro livro) {

		this(livro.getId(), livro.getTitulo(), livro.getDescricao(), livro.getOpniaoDoador(), livro.getQtdPaginas(),
				livro.getIsbn(), livro.getDataPublicacao(), new EditoraDTO(livro.getEditora()),
