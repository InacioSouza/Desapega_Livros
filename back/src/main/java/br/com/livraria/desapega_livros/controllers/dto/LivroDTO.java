...
public record LivroDTO(Integer id, String titulo, String subtitulo, String descricao, String opniaoDoador,
	...
	public LivroDTO(Livro livro) {
		...
		this(livro.getId(), livro.getTitulo(), livro.getSubtitulo(), livro.getDescricao(), livro.getOpniaoDoador(),
